...
All hardcoded values in `lib/mail-stack.ts` have been replaced with references to the centralized configuration module. This makes it easy to customize deployments without editing the stack code.
...
const logGroup = new logs.LogGroup(this, 'SmtpLogGroup', {
  logGroupName: `/aws/ec2/mail-${environment}`,
