# Mail Server - AWS Infrastructure

Automated AWS infrastructure deployment for the Mail Server using [ts-cloud](https://github.com/stacksjs/ts-cloud) with TypeScript and Bun.
...
- Namespace: `MailServer/<environment>`
...
aws secretsmanager rotate-secret --secret-id mail-credentials-prod
```
...
- [Mail Server Security Guide](../docs/SECURITY_GUIDE.md)
- [Mail Server Configuration](../docs/CONFIGURATION.md)
