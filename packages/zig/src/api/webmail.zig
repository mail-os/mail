...
const webmail_html =
    ...
    \\            { id: '3', name: 'Support Team', email: 'support@mail.local' }
    \\        ];
    \\        // Demo messages
    \\        const demoMessages = [
    \\            { id: '1', from: { name: 'Welcome Team', email: 'welcome@mail.local' }, subject: 'Welcome to your new email server!', preview: 'Congratulations on setting up your SMTP server...', date: 'Today', unread: true, starred: false, body: 'Congratulations on setting up your SMTP server!\\n\\nYour email server is now ready to use. Here are some things you can do:\\n\\n1. Send and receive emails\\n2. Manage your contacts\\n3. Organize with folders and labels\\n4. Search your messages\\n\\nEnjoy your new secure email experience!' },
    \\            { id: '2', from: { name: 'Security Alert', email: 'security@mail.local' }, subject: 'Your account security settings', preview: 'We recommend enabling two-factor authentication...', date: 'Yesterday', unread: true, starred: true, body: 'We recommend enabling two-factor authentication for your account to improve security.\\n\\nYou can configure this in your account settings.' },
    \\            { id: '3', from: { name: 'System Updates', email: 'updates@mail.local' }, subject: 'New features available', preview: 'Check out the latest features in v0.28.0...', date: 'Nov 25', unread: false, starred: false, body: 'New features in version 0.28.0:\\n\\n- Improved webmail interface\\n- Better mobile support\\n- Enhanced search\\n- Calendar integration\\n- Contact management\\n\\nUpdate now to get these features!' }
    \\        ];
